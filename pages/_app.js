...
const customTheme = {
	...
	colors: {
		...
		connectButtonBackground: "#51d6a6",
		connectButtonBackgroundError: "#51d6a6",
		connectButtonInnerBackground: "#51d6a6",
		...
		profileActionHover: "#51d6a6",
		profileForeground: "#04161a",
		selectedOptionBorder: "#51d6a6",
		standby: "#51d6a6",
	},
	fonts: {
		body: "",
